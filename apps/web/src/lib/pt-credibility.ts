...
const artefacts: PortugueseArtefact[] = [
  ...
  { id: 'A10', title: 'O quadro tem 52 países e não é o mundo', body: 'Os extremos de cada escala pertencem ao conjunto atual. Um score alto ou baixo é uma posição relativa neste quadro, não uma fração da capacidade mundial.' },
