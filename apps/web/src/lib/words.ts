...
export const PT_GLOSSARY: Record<string, PortugueseGlossaryEntry> = {
  ...
  'Indicator line': { group: 'How things change over time', term: 'Linha do indicador', short: 'A série histórica de um indicador, sem preenchimento de lacunas.', full: 'Cada indicador tem sua própria linha desde 1990, quando há dados. Cada ponto mantém valor bruto, valor normalizado e nível da fonte.' },
