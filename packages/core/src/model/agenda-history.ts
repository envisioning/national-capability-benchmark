 ...
 */
export const AGENDA_HISTORY_COUNTRIES = ['EST', 'SGP', 'KOR', 'DEU', 'GBR', 'URY', 'NLD', 'CHL', 'COL', 'JPN', 'PER', 'CRI', 'ECU', 'PAN', 'BOL', 'PRY', 'ARG', 'PHL', 'IDN', 'VNM', 'MYS', 'THA', 'ESP', 'POL', 'SWE', 'IRL'] as const
