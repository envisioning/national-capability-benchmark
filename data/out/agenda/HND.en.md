...
## Where Honduras stands

| Dimension | Score | Confidence | Trend |
| --- | --- | --- | --- |
| Anticipation | 16.4 | 0.55 (usable) | +9.3 over 10 years using 3 indicators |
| Agency | 31.2 | 0.61 (usable) | +15.4 over 10 years using 4 indicators |
| Coordination | 69.9 | 0.37 (thin) | no trend |
| Trust | not scored | 0.11 (very thin) | no trend |
| Learning | 41.5 | 0.48 (usable) | -8.5 over 10 years using 2 indicators |
| Experimentation | 1.6 | 0.15 (very thin) | no trend |
| Adaptability | 23.4 | 0.47 (usable) | -2.6 over 10 years using 4 indicators |
| Building | 28.7 | 0.62 (usable) | -0.9 over 10 years using 4 indicators |
| Shared Purpose | 40.5 | 0.36 (thin) | no trend |
...
### Adaptability: 23.4, confidence usable
...
### Building: 28.7, confidence usable
...
### Learning: 41.5, confidence usable
...
## What the indicators miss about Honduras

Documented deliveries linked to missing indicators. They do not affect scores or confidence.

- **Sistema Nacional de Emergencias 911** (Adaptability). Honduras's Sistema Nacional de Emergencias 911 coordinated and attended 762,601 of 788,573 emergency tickets in 2024, reporting 96.71% efficacy through five regional coordination centres.
