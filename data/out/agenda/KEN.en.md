...
| Agency | 43.2 | 0.6 (usable) | +11.7 over 10 years using 3 indicators, with 1 at the frame edge |
| Coordination | 80.7 | 0.41 (thin) | no trend |
| Trust | 42.4 | 0.26 (thin) | no trend |
| Learning | 26.8 | 0.51 (usable) | -6 over 10 years using 3 indicators |
| Experimentation | 0.9 | 0.17 (very thin) | no trend |
| Adaptability | 35.9 | 0.48 (usable) | -13 over 10 years using 4 indicators |
| Building | 17.5 | 0.62 (usable) | -3.1 over 10 years using 4 indicators |
| Shared Purpose | 52.7 | 0.28 (thin) | +2.2 over 10 years using 2 indicators |
...
### Learning: 26.8, confidence usable
...
### Adaptability: 35.9, confidence usable
