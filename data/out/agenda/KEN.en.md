...
| --- | --- | --- | --- |
| Anticipation | 24.2 | 0.67 (good) | +20.8 over 10 years using 3 indicators |
| Agency | 43.9 | 0.6 (usable) | +11.7 over 10 years using 3 indicators, with 1 at the frame edge |
| Coordination | 81.1 | 0.26 (thin) | no trend |
| Trust | 42.4 | 0.16 (very thin) | no trend |
| Learning | 26 | 0.51 (usable) | -6 over 10 years using 3 indicators |
| Experimentation | 0.9 | 0.17 (very thin) | no trend |
| Adaptability | 36.1 | 0.48 (usable) | -12.9 over 10 years using 4 indicators |
| Building | 17.5 | 0.54 (usable) | -3.1 over 10 years using 4 indicators |
| Shared Purpose | 52.7 | 0.24 (very thin) | +2.2 over 10 years using 2 indicators |

## What to raise

These are the lowest scores with usable evidence. Thin evidence appears below.

### Building: 17.5, confidence usable
...
### Anticipation: 24.2, confidence good
...
### Adaptability: 36.1, confidence usable
...
## What the indicators miss about Kenya
