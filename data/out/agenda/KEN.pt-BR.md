...
| --- | --- | --- | --- |
| Antecipação | 24,2 | 0,67 (boa) | +20,8 em 10 anos, sobre 3 indicadores |
| Agência | 43,9 | 0,6 (utilizável) | +11,7 em 10 anos, sobre 3 indicadores, 1 truncados na borda da régua |
| Coordenação | 81,1 | 0,26 (fraca) | sem base de tendência |
| Confiança | 42,4 | 0,16 (muito fraca) | sem base de tendência |
| Aprendizagem | 26 | 0,51 (utilizável) | -6 em 10 anos, sobre 3 indicadores |
| Experimentação | 0,9 | 0,17 (muito fraca) | sem base de tendência |
| Adaptação | 36,1 | 0,48 (utilizável) | -12,9 em 10 anos, sobre 4 indicadores |
| Construção | 17,5 | 0,54 (utilizável) | -3,1 em 10 anos, sobre 4 indicadores |
| Propósito compartilhado | 52,7 | 0,24 (muito fraca) | +2,2 em 10 anos, sobre 2 indicadores |
...
### Construção: 17,5, confiança utilizável
...
### Antecipação: 24,2, confiança boa
...
### Aprendizagem: 26, confiança utilizável
...
### Adaptação: 36,1, confiança utilizável
...
- Entregas documentadas em outros países: Plano Real, the 1994 currency stabilisation (Brasil); Proalcool, the fuel substitution after the oil shock (Brasil); The Convertibility Plan, and its collapse (Argentina); Kurzarbeit in the 2008-2009 crisis (Alemanha); The 2001 stabilisation, and its unwinding (Turquia); Telebras, the telecom system that was dismantled (Brasil); Estonian Defence League, national defence rebuilt after independence (Estônia); Korea Internet and Security Agency, a consolidated digital authority (Coreia do Sul); Federal siren warning network, and its dismantling (Alemanha); Room for the River, flood safety delivered across the Rhine branches (Países Baixos); Childcare benefits administration, and the recovery after institutional failure (Países Baixos).
...
### Agência: 43,9, confiança utilizável
...
- Entregas documentadas em outros países: SIBRATEC, the documented innovation-centre network (Brasil).
...
- **M-Pesa, and the regulator that let it run** (Coordenação). Kenya's central bank let a phone company build a national payments system in 2007 and supervised it into ubiquity, and by June 2026 Kenya had 94.2 million registered mobile money accounts and 572,104 agents, in a population of about 55 million.
