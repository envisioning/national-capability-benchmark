...
## Where Guatemala stands

| Dimension | Score | Confidence | Trend |
| --- | --- | --- | --- |
| Anticipation | 20.3 | 0.64 (usable) | +9.7 over 10 years using 5 indicators |
| Agency | 40.5 | 0.61 (usable) | +8 over 10 years using 4 indicators |
| Coordination | 53.2 | 0.37 (thin) | no trend |
| Trust | 12.4 | 0.26 (thin) | no trend |
| Learning | 42.7 | 0.56 (usable) | +3.2 over 10 years using 2 indicators |
| Experimentation | 1.4 | 0.1 (very thin) | no trend |
| Adaptability | 45.5 | 0.47 (usable) | -0.2 over 10 years using 4 indicators |
| Building | 28.9 | 0.62 (usable) | -0.5 over 10 years using 4 indicators |
| Shared Purpose | 36.4 | 0.39 (thin) | +7.7 over 10 years using 2 indicators |

## What to raise

These are the lowest scores with usable evidence. Thin evidence appears below.

### Anticipation: 20.3, confidence usable
...
### Adaptability: 45.5, confidence usable
...
## What the indicators miss about Guatemala

Documented deliveries linked to missing indicators. They do not affect scores or confidence.

- **Guatecompras, the national procurement marketplace** (Coordination). Guatemala's Ministry of Finance reported 152,676 enabled Guatecompras users in April 2023, including 137,950 registered suppliers alongside public buyers, auditors and oversight bodies using the national procurement system.
