...
## Where Nicaragua stands

| Dimension | Score | Confidence | Trend |
| --- | --- | --- | --- |
| Anticipation | 11.7 | 0.44 (thin) | +7.9 over 10 years using 3 indicators |
| Agency | 42.9 | 0.5 (usable) | +14.6 over 10 years using 3 indicators, with 1 at the frame edge |
| Coordination | 23.1 | 0.37 (thin) | no trend |
| Trust | 37.3 | 0.26 (thin) | no trend |
| Learning | 32 | 0.4 (thin) | +8.3 over 20 years using 2 indicators |
| Experimentation | 1.2 | 0.03 (very thin) | no trend |
| Adaptability | 41.9 | 0.47 (usable) | +2.2 over 10 years using 4 indicators |
| Building | 24.4 | 0.62 (usable) | -1.1 over 10 years using 4 indicators |
| Shared Purpose | 50.8 | 0.18 (very thin) | no trend |
...
### Shared Purpose: confidence 0.18, very thin
...
## What the indicators miss about Nicaragua

Documented deliveries linked to missing indicators. They do not affect scores or confidence.

- **Rural electrification and near-universal grid coverage** (Building). Nicaragua's Ministry of Energy and Mines reported national electricity coverage of 99.575% in December 2024 after public electrification projects brought power to 732,427 homes and 3,853,005 people.
