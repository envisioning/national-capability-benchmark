...
| Agency | 59.2 | 0.61 (usable) | +8.8 over 10 years using 4 indicators |
| Coordination | 71.7 | 0.24 (very thin) | no trend |
| Trust | not scored | 0.07 (very thin) | no trend |
| Learning | 23.4 | 0.51 (usable) | +5.7 over 10 years using 2 indicators |
| Experimentation | 18.8 | 0.39 (thin) | +1.8 over 10 years using 2 indicators |
| Adaptability | 23.6 | 0.47 (usable) | +2 over 10 years using 4 indicators |
| Building | 23.7 | 0.54 (usable) | -1.1 over 10 years using 4 indicators |
| Shared Purpose | 48 | 0.25 (very thin) | +2.5 over 10 years using 2 indicators, with 1 at the frame edge |

## What to raise

These are the lowest scores with usable evidence. Thin evidence appears below.

### Learning: 23.4, confidence usable
