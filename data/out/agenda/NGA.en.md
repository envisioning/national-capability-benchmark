...
| --- | --- | --- | --- |
| Anticipation | 17.5 | 0.55 (usable) | +10.3 over 10 years using 3 indicators |
| Agency | 41.1 | 0.57 (usable) | +11.4 over 10 years using 4 indicators |
| Coordination | 35.7 | 0.41 (thin) | no trend |
| Trust | 47.7 | 0.26 (thin) | no trend |
| Learning | 12.5 | 0.38 (thin) | +3.2 over 10 years using 2 indicators |
| Experimentation | 0.5 | 0.15 (very thin) | no trend |
| Adaptability | 59.5 | 0.47 (usable) | +3.4 over 10 years using 4 indicators, with 1 at the frame edge |
| Building | 16.8 | 0.62 (usable) | -0.5 over 10 years using 4 indicators |
| Shared Purpose | 66 | 0.22 (very thin) | no trend |

## What to raise

These are the lowest scores with usable evidence. Thin evidence appears below.

### Building: 16.8, confidence usable
...
### Anticipation: 17.5, confidence usable
...
## What the indicators miss about Nigeria

Documented deliveries linked to missing indicators. They do not affect scores or confidence.

- **eNaira, a national rollout with an adoption gap** (Adaptability). By June 2024, the Central Bank of Nigeria reported 28.46 million eNaira customers onboarded but only 197,041 active wallets, showing that the national CBDC rollout had not converted broad registration into sustained use.
