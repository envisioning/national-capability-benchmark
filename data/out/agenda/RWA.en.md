...
| --- | --- | --- | --- |
| Anticipation | 21.4 | 0.64 (usable) | +12.4 over 10 years using 5 indicators |
| Agency | 41.5 | 0.54 (usable) | +6.3 over 10 years using 3 indicators, with 1 at the frame edge |
| Coordination | 61.1 | 0.26 (thin) | no trend |
| Trust | not scored | 0.07 (very thin) | no trend |
| Learning | 22.4 | 0.56 (usable) | -6.8 over 10 years using 3 indicators |
| Experimentation | 0.4 | 0.18 (very thin) | +0.3 over 10 years using 2 indicators |
| Adaptability | 30.8 | 0.47 (usable) | +7.9 over 10 years using 4 indicators |
| Building | 25.3 | 0.52 (usable) | -2.2 over 10 years using 4 indicators, with 1 at the frame edge |
| Shared Purpose | 49.3 | 0.25 (very thin) | +4.6 over 10 years using 2 indicators |

## What to raise

These are the lowest scores with usable evidence. Thin evidence appears below.

### Anticipation: 21.4, confidence usable
...
### Learning: 22.4, confidence usable
...
### Adaptability: 30.8, confidence usable
...
- Related deliveries in other countries: Plano Real, the 1994 currency stabilisation (Brazil); Proalcool, the fuel substitution after the oil shock (Brazil); The Convertibility Plan, and its collapse (Argentina); Kurzarbeit in the 2008-2009 crisis (Germany); The 2001 stabilisation, and its unwinding (Turkey); Telebras, the telecom system that was dismantled (Brazil); Estonian Defence League, national defence rebuilt after independence (Estonia); Korea Internet and Security Agency, a consolidated digital authority (South Korea); Federal siren warning network, and its dismantling (Germany); Room for the River, flood safety delivered across the Rhine branches (Netherlands); Childcare benefits administration, and the recovery after institutional failure (Netherlands).
...
## What the indicators miss about Rwanda

Documented deliveries linked to missing indicators. They do not affect scores or confidence.

- **Umuganda community work** (Shared Purpose). Rwanda requires a morning of community work on the last Saturday of each month, and the government's own assessment reports average participation of 91.3 percent of adults countrywide in fiscal year 2015-2016, up from 87.8 percent two years earlier.
