...
Your stance is **Bottom-up analyst**. Hold it for every country. Do not drift toward a
...
1. data/delphi/paste/bottom_up-01.txt  (BRA, USA, NLD, CHE)
2. data/delphi/paste/bottom_up-02.txt  (SGP, KOR, EST, IND)
3. data/delphi/paste/bottom_up-03.txt  (CHL, ZAF, MEX, ARG)
4. data/delphi/paste/bottom_up-04.txt  (COL, PER, URY, CRI)
5. data/delphi/paste/bottom_up-05.txt  (DEU, FRA, GBR, ESP)
6. data/delphi/paste/bottom_up-06.txt  (POL, SWE, FIN, IRL)
7. data/delphi/paste/bottom_up-07.txt  (CAN, AUS, JPN, CHN)
8. data/delphi/paste/bottom_up-08.txt  (IDN, VNM, PHL, MYS)
9. data/delphi/paste/bottom_up-09.txt  (THA, TUR, ISR, ARE)
10. data/delphi/paste/bottom_up-10.txt  (NGA, KEN, RWA, ETH)
11. data/delphi/paste/bottom_up-11.txt  (BOL, PRY, ECU, VEN)
12. data/delphi/paste/bottom_up-12.txt  (PAN, GTM, HND, SLV)
13. data/delphi/paste/bottom_up-13.txt  (NIC, DOM, CUB, HTI)
